...
model chicago20_2
  ...
  BaseClasses.HotWaterLoop HotWaterLoop
    annotation (Placement(transformation(extent={{230,38},{248,56}})));
...
equation
  ...
  connect(add2.y, HotWaterLoop.u) annotation (Line(points={{219.4,53},{226,53},{
          226,53.3},{230,53.3}}, color={0,0,127}));
  connect(HotWaterLoop.port_b, splVal2.port_2) annotation (Line(points={{245.3,56.9},
          {244,56.9},{244,92}}, color={0,127,255}));
  ...
  connect(HotWaterLoop.port_a, splVal1.port_1) annotation (Line(points={{232.7,56.9},
          {232.7,66},{234,66},{234,76},{215,76},{215,80}}, color={0,127,255}));
  ...
  connect(splVal1.port_3, massFlowRate.port_a)
    annotation (Line(points={{210,85},{210,78},{192,78}}, color={0,127,255}));
  connect(splVal1.port_2, massFlowRate1.port_a) annotation (Line(points={{215,90},
          {214,90},{214,92},{186,92},{186,90}},     color={0,127,255}));
