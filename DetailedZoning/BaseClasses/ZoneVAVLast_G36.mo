...
model ZoneVAVLast_G36 "Base class with a zone and a VAV box"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TSupRoo(
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-30,-20})));
  Buildings.Obsolete.Examples.VAVReheat.BaseClasses.VAVBranch VAVbox(
...
equation
  ...
  connect(supplyAir1, zon.ports[2]) annotation (Line(points={{-100,80},{-80,80},
          {-80,66},{-19,66},{-19,80.9}}, color={0,127,255}));
  connect(zon.TAir, TRooAir) annotation (Line(points={{1,118},{24,118},{24,52},{
  ...
  connect(conVAVRoo.yDam_actual, VAVbox.y_actual) annotation (Line(points={{-82,
          -73.3333},{-88,-73.3333},{-88,-38},{6,-38},{6,-52},{2,-52}},
                                                             color={0,0,127}));
