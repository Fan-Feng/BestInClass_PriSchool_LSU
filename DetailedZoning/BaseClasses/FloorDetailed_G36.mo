...
model FloorDetailed_G36
  ...
  parameter Modelica.Units.SI.Volume Vzone6= 1000;//118.25;
  parameter Modelica.Units.SI.Volume Vzone7=204.21;
  parameter Modelica.Units.SI.Volume Vzone8= 800; //204.21;
  parameter Modelica.Units.SI.Volume Vzone9=62.94;
  parameter Modelica.Units.SI.Volume Vzone10=1000;//345.09;
...
//     annotation (Placement(transformation(extent={{-320,70},{-300,90}})));
  ...
  ZoneVAV_G36 zoneVAV1(
    ...
    annotation (Placement(transformation(extent={{-340,2},{-320,22}})));
...
equation
  ...
  connect(TRooHeaSet, zoneVAV1.TRooHeaSet) annotation (Line(
      points={{-396,40},{-362,40},{-362,17},{-341,17}},
      color={0,0,127},
      pattern=LinePattern.Dot));
  connect(TRooCooSet, zoneVAV1.TRooCooSet) annotation (Line(
      points={{-396,-20},{-368,-20},{-368,14},{-341,14}},
      color={0,0,127},
      pattern=LinePattern.Dot));
  ...
  connect(zoneVAV1.returnAir1, zoneVAV2.supplyAir1)
    annotation (Line(points={{-320,20},{-310,20},{-310,18},{-300,18}},
                                                   color={0,127,255}));
  connect(zoneVAV1.supplyAir, zoneVAV2.returnAir)
    annotation (Line(points={{-320,0},{-310,0},{-310,2},{-300,2}},
                                                 color={0,127,255}));
  ...
  connect(zoneVAV2.supplyAir, zoneVAV3.returnAir)
    annotation (Line(points={{-280,-2},{-270,-2},{-270,2},{-260,2}},
                                                 color={0,127,255}));
  ...
  connect(zoneVAV3.supplyAir, zoneVAV4.returnAir)
    annotation (Line(points={{-240,-2},{-230,-2},{-230,2},{-220,2}},
                                                 color={0,127,255}));
  ...
  connect(zoneVAV4.supplyAir, zoneVAV5.returnAir)
    annotation (Line(points={{-200,-2},{-190,-2},{-190,2},{-180,2}},
                                                 color={0,127,255}));
  ...
  connect(zoneVAV5.supplyAir, zoneVAV6.returnAir)
    annotation (Line(points={{-160,-2},{-150,-2},{-150,2},{-140,2}},
                                                 color={0,127,255}));
  ...
  connect(zoneVAV6.supplyAir, zoneVAV7.returnAir)
    annotation (Line(points={{-120,-2},{-110,-2},{-110,2},{-100,2}},
                                                 color={0,127,255}));
  ...
  connect(zoneVAV7.supplyAir, zoneVAV8.returnAir)
    annotation (Line(points={{-80,-2},{-70,-2},{-70,2},{-60,2}},
                                               color={0,127,255}));
  ...
  connect(zoneVAV8.supplyAir, zoneVAV9.returnAir)
    annotation (Line(points={{-40,-2},{-30,-2},{-30,2},{-20,2}},
                                               color={0,127,255}));
  ...
  connect(zoneVAV9.supplyAir, zoneVAV10.returnAir)
    annotation (Line(points={{0,-2},{10,-2},{10,2},{20,2}},
                                            color={0,127,255}));
  ...
  connect(zoneVAV10.supplyAir, zoneVAV11.returnAir)
    annotation (Line(points={{40,-2},{50,-2},{50,2},{60,2}},
                                             color={0,127,255}));
  ...
  connect(zoneVAV11.supplyAir, zoneVAV12.returnAir)
    annotation (Line(points={{80,-2},{90,-2},{90,2},{100,2}},
                                              color={0,127,255}));
  ...
  connect(zoneVAV12.supplyAir, zoneVAV13.returnAir)
    annotation (Line(points={{120,-2},{130,-2},{130,2},{140,2}},
                                               color={0,127,255}));
  ...
  connect(zoneVAV13.supplyAir, zoneVAV14.returnAir)
    annotation (Line(points={{160,-2},{170,-2},{170,2},{180,2}},
                                               color={0,127,255}));
  ...
  connect(zoneVAV14.supplyAir, zoneVAV15.returnAir)
    annotation (Line(points={{200,-2},{210,-2},{210,2},{220,2}},
                                               color={0,127,255}));
  ...
  connect(zoneVAV15.supplyAir, zoneVAV16.returnAir)
    annotation (Line(points={{240,-2},{250,-2},{250,2},{260,2}},
                                               color={0,127,255}));
  ...
  connect(zoneVAV16.supplyAir, zoneVAV17.returnAir)
    annotation (Line(points={{280,-2},{290,-2},{290,2},{300,2}},
                                               color={0,127,255}));
  ...
  connect(zoneVAV17.supplyAir, zoneVAV18.returnAir)
    annotation (Line(points={{320,-2},{330,-2},{330,2},{340,2}},
                                               color={0,127,255}));
  ...
  connect(zoneVAV18.supplyAir, zoneVAV19.returnAir)
    annotation (Line(points={{360,-2},{370,-2},{370,2},{380,2}},
                                               color={0,127,255}));
  ...
  connect(zoneVAV19.supplyAir, zoneVAV20.returnAir)
    annotation (Line(points={{400,-2},{410,-2},{410,2},{420,2}},
                                               color={0,127,255}));
  ...
  connect(zoneVAV1.uOpeMod, zoneVAV21.uOpeMod) annotation (Line(
      points={{-342,7},{-346,7},{-346,-80},{456,-80},{456,5},{458,5}},
      color={255,127,0},
      pattern=LinePattern.Dot));
