...
model all_22
  ...
  parameter Modelica.Units.SI.Temperature THeaOff= 273.15 + 22
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant warCooTim[numZon](final k=
        fill(0, numZon))    "Warm up and cool down time"
    annotation (Placement(transformation(extent={{-242,-58},{-222,-38}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant warCooTim1
                                                             [numZon](final k=
        fill(7200, numZon)) "Warm up and cool down time"
    annotation (Placement(transformation(extent={{-242,-96},{-222,-76}})));
protected
...
equation
  ...
  connect(Building.yZonPreResReq, PZonResReq.u[1:21]) annotation (Line(points={{172,5},
          {174,5},{174,-106},{16,-106},{16,-86.6667},{18,-86.6667}},
        color={255,127,0}));
  connect(Building.yZonTemResReq, TZonResReq.u[1:21]) annotation (Line(points={{172,7.4},
          {176,7.4},{176,-108},{14,-108},{14,-56.6667},{18,-56.6667}},
        color={255,127,0}));
  ...
  connect(warCooTim.y, zonSta.cooDowTim) annotation (Line(points={{-220,-48},{-214,
          -48},{-214,-70},{-202,-70}},      color={0,0,127}));
  ...
  connect(warCooTim1.y, zonSta.warUpTim) annotation (Line(points={{-220,-86},{-210,
          -86},{-210,-74},{-202,-74}}, color={0,0,127}));
