...
//     annotation (Placement(transformation(extent={{-320,70},{-300,90}})));
  ...
  ZoneVAV_1964WithValve zoneVAV14(
  ...
  Modelica.Fluid.Sensors.MassFlowRate massFlowRate2
    annotation (Placement(transformation(extent={{-234,-170},{-214,-150}})));
  Modelica.Fluid.Sensors.MassFlowRate massFlowRate3
    annotation (Placement(transformation(extent={{-192,-170},{-172,-150}})));
...
equation
  ...
  connect(splVal15.port_2, splVal16.port_1)
    annotation (Line(points={{240,-160},{264,-160}}, color={0,127,255}));
  connect(splVal16.port_2, splVal17.port_1)
    annotation (Line(points={{280,-160},{306,-160}}, color={0,127,255}));
  ...
  connect(splVal16.port_3, zoneVAV16.port_a) annotation (Line(points={{272,-152},
          {274,-152},{274,-3.8},{273.4,-3.8}}, color={0,127,255}));
  ...
  connect(splVal2.port_2, massFlowRate1.port_a)
    annotation (Line(points={{-282,-160},{-278,-160}}, color={0,127,255}));
  connect(massFlowRate1.port_b, splVal3.port_1)
    annotation (Line(points={{-258,-160},{-254,-160}}, color={0,127,255}));
  connect(splVal3.port_2, massFlowRate2.port_a)
    annotation (Line(points={{-238,-160},{-234,-160}}, color={0,127,255}));
  connect(massFlowRate2.port_b, splVal4.port_1)
    annotation (Line(points={{-214,-160},{-210,-160}}, color={0,127,255}));
  connect(splVal4.port_2, massFlowRate3.port_a)
    annotation (Line(points={{-194,-160},{-192,-160}}, color={0,127,255}));
  connect(massFlowRate3.port_b, splVal5.port_1) annotation (Line(points={{-172,
          -160},{-170,-160}},             color={0,127,255}));
  connect(splVal5.port_2, splVal6.port_1)
    annotation (Line(points={{-154,-160},{-138,-160}}, color={0,127,255}));
  connect(splVal7.port_2, massFlowRate4.port_a)
    annotation (Line(points={{-84,-160},{-80,-160}}, color={0,127,255}));
  connect(massFlowRate4.port_b, splVal8.port_1)
    annotation (Line(points={{-60,-160},{-54,-160}}, color={0,127,255}));
