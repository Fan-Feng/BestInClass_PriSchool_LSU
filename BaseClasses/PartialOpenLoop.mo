...
protected
  model Results "Model to store the results of the simulation"
    ...
    input Modelica.Units.SI.Power PFan "Fan power";
    input Modelica.Units.SI.Power PHeaAHU "AHU heating coil power";
    input Modelica.Units.SI.Power PHeaReh "Reheat coil power";
    //input Modelica.SIunits.Power PHea "Total heating power";
    input Modelica.Units.SI.Power PCooSen "Sensible cooling power";
    input Modelica.Units.SI.Power PCooLat "Latent cooling power";
