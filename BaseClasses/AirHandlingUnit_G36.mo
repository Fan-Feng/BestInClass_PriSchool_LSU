...
model AirHandlingUnit_G36 "Air handing system for VAV"
  ...
  Buildings.Fluid.HeatExchangers.DryCoilEffectivenessNTU heaCoi(
    ...
    m1_flow_nominal=m_flow_nominal*1006*30/4200/10,
    m2_flow_nominal=m_flow_nominal,
    configuration=Buildings.Fluid.Types.HeatExchangerConfiguration.CounterFlow,
    Q_flow_nominal=m_flow_nominal*1006*30,
    dp1_nominal=0,
    dp2_nominal=200 + 200 + 100 + 40,
    allowFlowReversal1=allowFlowReversal,
    allowFlowReversal2=allowFlowReversal,
    T_a1_nominal=313.15,
    T_a2_nominal=263.15) "Heating coil"
    annotation (Placement(transformation(extent={{124,68},{104,48}})));
...
public
  Buildings.Controls.OBC.CDL.Reals.MultiplyByParameter gaiHeaCoi(k=
        m_flow_nominal*1000*30/4200/10) "Gain for heating coil mass flow rate"
    annotation (Placement(transformation(extent={{108,-112},{128,-92}})));
...
equation
  ...
  connect(cooCoi.port_a1,souCoo. ports[1]) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(gaiHeaCoi.y,souHea. m_flow_in) annotation (Line(points={{130,-102},{
          130,-30}},             color={0,0,127}));
