...
model ZoneVAV_G36 "Base class with a zone and a VAV box"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TSupRoo(
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-30,-20})));
  BestInClass.DetailedZoning.BaseClasses.zhang_vav VAVbox(
  ...
  Modelica.Fluid.Interfaces.FluidPort_a supplyAir(redeclare final package
    ...
    annotation (Placement(transformation(extent={{90,-130},{110,-110}}),
        iconTransformation(extent={{90,-130},{110,-110}})));
...
equation
  ...
  connect(splSupRoo.port_3, VAVbox.port_a) annotation (Line(
      points={{-30,-110},{-30,-100},{-30,-88},{-30,-88}},
      color={0,127,255},
      thickness=0.5));
  connect(TSupRoo.port_b, VSupRoo_flow.port_a)   annotation (Line(points={{-30,-10},{-30,0}},color={0,127,255}));
  connect(TSupRoo.port_a, VAVbox.port_b)   annotation (Line(points={{-30,-30},{
          -30,-40},{-30,-48},{-30,-48}},                                                  color={0,127,255}));
  connect(conVAVRoo.yVal, VAVbox.yVal) annotation (Line(points={{-58,-65},{-54,
          -65},{-54,-76},{-44,-76}}, color={0,0,127}));
  connect(conVAVRoo.yDam, VAVbox.yVAV) annotation (Line(points={{-58,-61.6667},
          {-56,-61.6667},{-56,-60},{-44,-60}},
                                     color={0,0,127}));
  connect(splSupRoo.port_2, supplyAir) annotation (Line(points={{-20,-120},{100,
          -120}},                    color={0,127,255}));
  ...
  connect(conVAVRoo.yDam_actual, VAVbox.y_actual) annotation (Line(points={{-82,
          -73.3333},{-88,-73.3333},{-88,-38},{8,-38},{8,-52},{2,-52}},
                                                             color={0,0,127}));
