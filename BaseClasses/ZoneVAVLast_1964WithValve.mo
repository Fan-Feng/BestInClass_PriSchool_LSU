...
model ZoneVAVLast_1964WithValve
...
equation
  ...
  connect(conVAVRoo.yDam, VAVbox.yVAV) annotation (Line(points={{-58,-61.6667},
          {-58,-57.6},{-43.2,-57.6}},color={0,0,127}));
  connect(VAVbox.y_actual, conVAVRoo.yDam_actual) annotation (Line(points={{-6.4,
          -51.2},{-6.4,-46},{-88,-46},{-88,-73.3333},{-82,-73.3333}}, color={0,0,
          127}));
  ...
  connect(conVAVRoo.yVal, val_y) annotation (Line(points={{-58,-65},{-52,-65},{
          -52,-136},{70,-136},{70,-150}}, color={0,0,127}));
  connect(conVAVRoo.yVal, VAVbox.u) annotation (Line(points={{-58,-65},{-50,-65},
