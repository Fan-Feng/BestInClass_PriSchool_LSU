...
//     "Heating airflow set point (ratio to nominal)";
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant conOne(k=1) "Constant 1"
    annotation (Placement(transformation(extent={{-60,-50},{-40,-30}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant conZer(k=0) "Constant 0"
    annotation (Placement(transformation(extent={{30,30},{50,50}})));

  Buildings.Controls.OBC.CDL.Reals.Hysteresis hysWitHol(final uLow=-dTHys,
      final uHigh=0) "Output true if room temperature below heating set point"
    annotation (Placement(transformation(extent={{-10,130},{10,150}})));
  Buildings.Obsolete.Controls.OBC.CDL.Continuous.Feedback dTHea
  ...
  Buildings.Obsolete.Controls.OBC.CDL.Continuous.Feedback dTSet
