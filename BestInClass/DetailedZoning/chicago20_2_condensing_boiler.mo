...
model chicago20_2_condensing_boiler
  ...
  BaseClasses.dual_condensing_Boiler_system boiler_system
    annotation (Placement(transformation(extent={{242,36},{260,54}})));
protected
...
equation
  ...
  connect(boiler_system.port_a, splVal2.port_2) annotation (Line(points={{260,
          46.08},{260,92},{244,92}}, color={0,127,255}));
  connect(boiler_system.port_b, splVal1.port_1) annotation (Line(points={{
          260.18,43.92},{264,43.92},{264,28},{215,28},{215,82}}, color={0,127,
          255}));
  annotation (Diagram(coordinateSystem(extent={{-260,-140},{200,140}})),
      ...
      __Dymola_Algorithm="Radau"),
        ...
        coordinateSystem(preserveAspectRatio=false)),
              Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)));
end chicago20_2_condensing_boiler;
