...
model VAVWithValve
  ...
  Buildings.Fluid.HeatExchangers.DryCoilEffectivenessNTU terHea(
    ...
    m2_flow_nominal=m_flow_nominal*1006*(30 - 16.7)/4200/(55 - 45),
    Q_flow_nominal=m_flow_nominal*1006*(30 - 16.7),
    ...
    T_a1_nominal=293.15,
    T_a2_nominal=323.15) "Heat exchanger of terminal box" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-44,-6})));
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayEqualPercentage val(
    ...
    dpValve_nominal(displayUnit="Pa") = 8000,
    m_flow_nominal=m_flow_nominal*1006*16/4200/10,
...
equation
  ...
  connect(massFlowRate.port_b, terHea.port_a2)
    annotation (Line(points={{-20,8},{-30,8},{-30,4},{-38,4}},
                                               color={0,127,255}));
  connect(terHea.port_b2, port_b1) annotation (Line(points={{-38,-16},{-6,-16},
