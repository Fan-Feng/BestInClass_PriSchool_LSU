...
model ZoneVAV_1964
  ...
  BestInClass.DetailedZoning.BaseClasses.VAVBranch VAVbox(
  ...
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo annotation (Placement(
        ...
        rotation=90,
        origin={35,-75})));
  Modelica.Blocks.Interfaces.RealOutput val_y
...
equation
  ...
  connect(conVAVRoo.yZonPreResReq, yZonPreResReq) annotation (Line(points={{-58,
          -69.6667},{-56,-69.6667},{-56,-94},{26,-94},{26,-60},{110,-60}},
                                                                 color={255,127,
          0}));
  connect(conVAVRoo.TZon, zon.TAir) annotation (Line(points={{-82,-68},{-84,-68},
  ...
  connect(TSupRoo.T, TDis) annotation (Line(points={{-41,-20},{-62,-20},{-62,0},
          {110,0}}, color={0,0,127}));
  ...
  connect(conVAVRoo.yDam, VAVbox.yVAV) annotation (Line(points={{-58,-59.6667},
          {-58,-59.6},{-41.2,-59.6}},color={0,0,127}));
  connect(VAVbox.y_actual, conVAVRoo.yDam_actual) annotation (Line(points={{-4.4,
          -53.2},{-4.4,-46},{-88,-46},{-88,-71.3333},{-82,-71.3333}}, color={0,0,
          127}));
  ...
  connect(conVAVRoo.yVal, val_y) annotation (Line(points={{-58,-63},{-52,-63},{
          -52,-156},{54,-156},{54,-136},{70,-136},{70,-150}}, color={0,0,127}));
