...
model VAVBranch "Supply branch of a VAV system"
  ...
  Buildings.Fluid.HeatExchangers.DryCoilEffectivenessNTU terHea(
    ...
    m2_flow_nominal=m_flow_nominal*1006*20/4200/10,
    Q_flow_nominal=m_flow_nominal*1006*20,
...
equation
  ...
  connect(massFlowRate.port_a, port_a1) annotation (Line(points={{0,8},{40,8},{
          40,32},{100,32},{100,40}}, color={0,127,255}));
  annotation (Icon(
    graphics={
        Rectangle(
