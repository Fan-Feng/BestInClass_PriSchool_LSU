...
package FlowMover "\"Component used for modelling fans and pumps\""
  ...
  package Control
    ...
    model VAVDualFanControl
      ...
      Buildings.Controls.OBC.CDL.Reals.LimitSlewRate ramLim(raisingSlewRate=1/120)
        "Ramp limiter for fan control signal"
        annotation (Placement(transformation(extent={{40,-10},{60,10}})));
      Buildings.Controls.OBC.CDL.Reals.Limiter lim(uMax=1, uMin=0)
...
First implementation.
    ...
    model PumpSystem "This model is used to simulate the secondary chilled water pump"
      ...
      BestInClass.DetailedZoning.BaseClasses.FlowMover.BaseClasses.WithoutMotor
        pum[n](
    ...
    package Control
      ...
      model SecPumCon "This model is used for secondary chilled water pump control."
        parameter Real tWai = 300 "Waiting time";
          ...
          "the number of pumps";
        BestInClass.DetailedZoning.BaseClasses.Control.PumpStageN
          pumSta(
          tWai=tWai,
          thehol_up=0.9,
          n=n,
