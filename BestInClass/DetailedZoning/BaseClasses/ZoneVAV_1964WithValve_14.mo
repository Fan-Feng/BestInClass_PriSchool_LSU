...
model ZoneVAV_1964WithValve_14
  ...
  parameter Modelica.Units.SI.MassFlowRate mSpl_flow_nominal
  ...
  BestInClass.DetailedZoning.BaseClasses.VAV_Controller_14
    conVAVRoo(
    final AFlo=AFlo,
    ...
    VDisHeaSetMax_flow=0.7*VRoo_flow_nominal)
  ...
  BestInClass.DetailedZoning.BaseClasses.VAVWithValve VAVbox(
    ...
    annotation (Placement(transformation(extent={{-38,-82},{-6,-50}})));
  Modelica.Fluid.Interfaces.FluidPort_a port_a
    annotation (Placement(transformation(extent={{24,-148},{44,-128}})));
  ...
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo annotation (Placement(
        ...
        rotation=90,
        origin={35,-75})));
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo1 annotation (Placement(
        transformation(
        extent={{7,-7},{-7,7}},
        rotation=90,
        origin={-1,-111})));
...
equation
  ...
  connect(conVAVRoo.yZonPreResReq, yZonPreResReq) annotation (Line(points={{-58,
          -71.6667},{-56,-71.6667},{-56,-94},{26,-94},{26,-60},{110,-60}},
                                                                 color={255,127,
          0}));
  connect(conVAVRoo.TZon, zon.TAir) annotation (Line(points={{-82,-70},{-84,-70},
          {-84,-100},{24,-100},{24,118},{1,118}},     color={0,0,127}));
  ...
  connect(conVAVRoo.yDam, VAVbox.yVAV) annotation (Line(points={{-58,-61.6667},
          {-58,-59.6},{-41.2,-59.6}},color={0,0,127}));
  connect(VAVbox.y_actual, conVAVRoo.yDam_actual) annotation (Line(points={{-4.4,
          -53.2},{-4.4,-46},{-88,-46},{-88,-73.3333},{-82,-73.3333}}, color={0,0,
          127}));
  connect(TSupRoo.port_a, VAVbox.port_b)
    annotation (Line(points={{-30,-30},{-30,-50}}, color={0,127,255}));
  connect(splSupRoo.port_3, VAVbox.port_a)
    annotation (Line(points={{-30,-110},{-30,-82}}, color={0,127,255}));
  connect(senMasFlo.port_b, VAVbox.port_a1) annotation (Line(points={{35,-68},{
          34,-68},{34,-60},{-6,-60},{-6,-59.6}}, color={0,127,255}));
  connect(supplyAir, supplyAir)
    annotation (Line(points={{100,-80},{100,-80}}, color={0,127,255}));
  connect(senMasFlo1.port_b, port_b) annotation (Line(points={{-1,-118},{-1,-128},
          {0,-128},{0,-140}},       color={0,127,255}));
  connect(senMasFlo.port_a, port_a)
    annotation (Line(points={{35,-82},{34,-82},{34,-138}}, color={0,127,255}));
  connect(VAVbox.port_b1, senMasFlo1.port_a) annotation (Line(points={{-6,-72.4},
          {-2,-72.4},{-2,-104},{-1,-104}}, color={0,127,255}));
  connect(conVAVRoo.yVal, VAVbox.u) annotation (Line(points={{-58,-65},{-52,-65},
          {-52,-72.4},{-41.2,-72.4}}, color={0,0,127}));

  connect(conVAVRoo.yVal, val_y) annotation (Line(points={{-58,-65},{8,-65},{8,
          -112},{66,-112},{66,-150}}, color={0,0,127}));
