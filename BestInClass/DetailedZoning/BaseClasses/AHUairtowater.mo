...
model AHUairtowater
  ...
  Buildings.Fluid.HeatExchangers.DryCoilEffectivenessNTU heaCoi(
    ...
    T_a1_nominal=318.15,
    T_a2_nominal=281.65,
    m1_flow_small=0.01*abs(m_flow_nominal*1006*(16.7-8.5)/4200/10),
    m2_flow_small=0.01*abs(m_flow_nominal)) "Heating coil"
    annotation (Placement(transformation(extent={{128,66},{108,46}})));
                      //200 + 200 + 100 + 40,
  ...
  Buildings.Fluid.HeatExchangers.WetCoilCounterFlow cooCoi(
    ...
    annotation (Placement(transformation(extent={{216,68},{196,48}})));
  ...
  Modelica.Fluid.Interfaces.FluidPort_b port_b
    annotation (Placement(transformation(extent={{90,-202},{110,-182}}),
...
equation
  ...
  connect(cooCoi.port_b2,fanSup. port_a) annotation (Line(
      points={{216,64},{262,64},{262,62},{306,62}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  ...
  connect(heaCoi.port_b2,cooCoi. port_a2) annotation (Line(
      points={{128,62},{162,62},{162,64},{196,64}},
      color={0,127,255},
      thickness=0.5));
  ...
  connect(heaCoi.port_a1, massFlowRate.port_b)
    annotation (Line(points={{128,50},{140,50},{140,-6}}, color={0,127,255}));
  ...
  connect(heaCoi.port_b1, massFlowRate1.port_a)
    annotation (Line(points={{108,50},{100,50},{100,4}}, color={0,127,255}));
  connect(port_b, massFlowRate1.port_b) annotation (Line(points={{100,-192},{
          100,-16}},            color={0,127,255}));
