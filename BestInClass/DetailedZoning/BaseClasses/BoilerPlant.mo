...
model BoilerPlant "Boiler hot water plant"
  ...
  parameter Real Cap[:] = {30889*alpha/n for i in linspace(1, n, n)} "Rated Plant Capacity";
  parameter Modelica.Units.SI.MassFlowRate mHW_flow_nominal[:]={0.735/n*alpha for i in linspace(
      1,
      n,
  ...
  BestInClass.DetailedZoning.BaseClasses.FlowMover.Pump.PumpSystem
    pumSecHW(
  ...
  BestInClass.DetailedZoning.BaseClasses.FlowMover.Pump.Control.SecPumCon
    secPumCon(tWai=1800, n=m)
  ...
  replaceable Buildings.Fluid.Sensors.TemperatureTwoPort senTHWBuiEnt(
    ...
    m_flow_nominal=sum(mHW_flow_nominal))
        ...
        origin={64,-96})));
  replaceable
    BestInClass.DetailedZoning.BaseClasses.Boiler.MultiBoilers
    mulBoi(
    ...
    n=n,
    THW_start=THW_start)
    annotation (Placement(transformation(extent={{-98,-50},{-64,-16}})));
  ...
  BestInClass.DetailedZoning.BaseClasses.Control.PlantStageN_Copy
    boiSta(
    tWai=1800,
    n=n,
    thehol=thrhol,
    Cap=Cap) annotation (Placement(transformation(extent={{-80,62},{-60,82}})));
...
equation
  ...
  connect(mulBoi.port_a_HW, pumSecHW.port_b) annotation (Line(
      points={{-64,-19.4},{-64,30},{-10,30}},
      color={255,0,0},
      thickness=1));
  connect(mulBoi.port_b_HW, senTHWBuiEnt.port_a) annotation (Line(
      points={{-64,-46.6},{-58,-46.6},{-58,-96},{54,-96}},
      color={255,0,0},
      thickness=1));

  connect(pumSecHW.speRat, secPumCon.sta) annotation (Line(points={{-11,36.2},{
          -18,36.2},{-18,48},{58,48}},        color={0,0,127}));
  connect(senTHWBuiEnt.port_b, port_b) annotation (Line(
      points={{74,-96},{106,-96},{106,-60},{240,-60}},
      color={255,0,0},
      thickness=1));
  connect(boiSta.On, reaToBoolea.y) annotation (Line(points={{-82,80},{-120,80},
  ...
  connect(mulBoi.Rat, boiSta.sta) annotation (Line(points={{-62.3,-39.8},{-32,
          -39.8},{-32,34},{-92,34},{-92,64},{-82,64}}, color={0,0,127}));
  connect(boiSta.y, mulBoi.On) annotation (Line(points={{-59,72},{-42,72},{-42,
          28},{-142,28},{-142,-39.8},{-99.53,-39.8}},     color={0,0,127}));
  ...
  connect(senMasFlo.port_b, pumSecHW.port_a) annotation (Line(
      points={{74,19},{48,19},{48,30},{10,30}},
      color={255,0,0},
      thickness=1));
  connect(senMasFlo.port_a, senTHWBuiLea.port_b) annotation (Line(
      points={{92,19},{102,19},{102,22},{110,22}},
      color={255,0,0},
      thickness=1));
  connect(realExpression.y,boiSta.loa)  annotation (Line(points={{41,-40},{-20,
          -40},{-20,2},{-110,2},{-110,72},{-82,72}},
                                                color={0,0,127}));
  connect(secPumCon.y,pumSecHW.speSig)  annotation (Line(
      points={{81,56},{86,56},{86,38},{10.9,38}},
      color={0,0,127}));
  connect(mulBoi.THWSet, THWSet) annotation (Line(points={{-99.53,-26.2},{-220,
          -26.2},{-220,60},{-300,60}}, color={0,0,127}));
  ...
  connect(senMasFlo.m_flow, mHW_tot) annotation (Line(points={{83,28.9},{100,
          28.9},{100,60},{250,60}}, color={0,0,127}));
