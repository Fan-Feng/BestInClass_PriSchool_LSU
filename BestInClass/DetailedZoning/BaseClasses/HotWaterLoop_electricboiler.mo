...
model HotWaterLoop_electricboiler
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort temSup(redeclare package Medium =
        Buildings.Media.Water,          m_flow_nominal=3.46)
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={616,132})));
  ...
  Modelica.Fluid.Sensors.MassFlowRate massFlowRate3
    annotation (Placement(transformation(extent={{246,-66},{266,-46}})));
  ...
  Buildings.Controls.OBC.CDL.Reals.Hysteresis
               ...
               "Hysteresis for pump"
    annotation (Placement(transformation(extent={{134,110},{154,130}})));
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant THeaWatSupSet(k=273.15 + 30,
  ...
  HeaterCooler_u hea(
    ...
    T_start=289.15,
    Q_flow_nominal=30889) "Heater"
    annotation (Placement(transformation(extent={{372,-66},{392,-46}})));
  ...
  Buildings.Fluid.Sources.Boundary_pT bou(redeclare package Medium = Medium,
    ...
    annotation (Placement(transformation(extent={{100,-62},{118,-44}})));
  Buildings.Fluid.FixedResistances.PressureDrop
    ...
    annotation (Placement(transformation(extent={{156,-64},{138,-48}})));
equation
  ...
  connect(temRet3.port_b, massFlowRate3.port_a)
    annotation (Line(points={{208,-56},{246,-56}}, color={0,127,255}));
  ...
  connect(hysPum1.y, booToReaBoi.u) annotation (Line(points={{156,120},{192,120},
          {192,104},{202,104}}, color={255,0,255}));
  connect(u, hysPum1.u) annotation (Line(points={{0,158},{100,158},{100,120},{
          132,120}}, color={0,0,127}));
  connect(temRet.port_a, port_b) annotation (Line(points={{676,144},{688,144},{
          688,260},{660,260},{660,280}}, color={0,127,255}));
  ...
  connect(THeaWatSupSet1.y, conVal.u_s) annotation (Line(points={{484,52},{540,52}},
                              color={0,0,127}));
  connect(hysPum1.y, conPI.On) annotation (Line(points={{156,120},{156,116},{
          176,116},{176,58},{266,58}},               color={255,0,255}));
  ...
  connect(conPI.y, hea.u) annotation (Line(points={{289,52},{352,52},{352,-50},
          {370,-50}},color={0,0,127}));
  connect(hea.port_b, massFlowRate5.port_a)
    annotation (Line(points={{392,-56},{432,-56}}, color={0,127,255}));
  connect(hea.port_a, massFlowRate3.port_b) annotation (Line(points={{372,-56},{
          266,-56}},                     color={0,127,255}));
  connect(massFlowRate2.port_b, hea.port_a) annotation (Line(points={{406,-110},
          {360,-110},{360,-56},{372,-56}}, color={0,127,255}));
  connect(res.port_b,bou. ports[1])
    annotation (Line(points={{138,-56},{124,-56},{124,-53},{118,-53}},
                                                          color={0,127,255}));
  connect(res.port_a, temRet3.port_a)
    annotation (Line(points={{156,-56},{188,-56}}, color={0,127,255}));
...
end HotWaterLoop_electricboiler;
