...
model ZoneVAVLast_1964_gas_furnace
...
equation
  ...
  connect(val_y, conVAVRoo.yVal) annotation (Line(points={{50,-110},{-54,-110},
          {-54,-78},{-50,-78},{-50,-63},{-56,-63}}, color={0,0,127}));
  connect(conVAVRoo.yVal, VAVbox.y_val) annotation (Line(points={{-56,-63},{-52,
          -63},{-52,-70.08},{-43.2,-70.08}}, color={0,0,127}));
  annotation (Icon(                                             graphics={
        ...
        coordinateSystem(preserveAspectRatio=false)),
              Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)));
end ZoneVAVLast_1964_gas_furnace;
