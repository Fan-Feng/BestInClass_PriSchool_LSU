...
model HotWaterLoop_2 "Model of a hydronic heating system with energy storage"
  ...
  parameter Real capHea_nominal = 88548;
...
equation
  ...
  connect(y1Hea.y[1], bus.y1Hea) annotation (Line(points={{96,68},{188,68},{188,
          56},{244,56},{244,22}}, color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(hysPum1.y, bus.y1) annotation (Line(points={{156,118},{156,116},{192,116},
          {192,68},{244,68},{244,22}}, color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(THeaWatSupSet.y, bus.TSet) annotation (Line(points={{98,20},{98,22},{244,
...
First implementation.
    ...
    Icon(coordinateSystem(extent={{20,-140},{720,280}})));
end HotWaterLoop_2;
