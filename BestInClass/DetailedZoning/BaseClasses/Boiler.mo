...
package Boiler
  ...
  model MultiBoilers "The boiler system with N boilers and associated local controllers."
    ...
    Boiler boi[n](
      ...
      eta=eta,
      each boi(T_start(displayUnit="K")=293.15),
      THW=THW_start,
      GaiPi=1,
      tIntPi=60)
  ...
  model Boiler "Boiler"
    ...
    BestInClass.DetailedZoning.BaseClasses.Boiler.BaseClasses.BoilerTable boi(
    ...
    replaceable Buildings.Fluid.Sensors.TemperatureTwoPort senTHWLea(
      ...
      T_start=THW) annotation (Placement(transformation(extent={{20,-90},{36,-74}})));
  ...
  equation
    connect(senTHWLea.port_b, valHW.port_a) annotation (Line(
        points={{36,-82},{48,-82},{48,-80},{60,-80}},
        color={255,0,0},
        thickness=1));
