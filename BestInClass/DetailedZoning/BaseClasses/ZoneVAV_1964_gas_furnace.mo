...
model ZoneVAV_1964_gas_furnace
  ...
  BestInClass.DetailedZoning.BaseClasses.VAV_gas_furnace VAVbox(
...
equation
  ...
  connect(conVAVRoo.yVal, val_y) annotation (Line(points={{-58,-65},{-52,-65},{
          -52,-134},{42,-134},{42,-126},{58,-126}}, color={0,0,127}));
  connect(conVAVRoo.yVal, VAVbox.y_val) annotation (Line(points={{-58,-65},{-52,
          -65},{-52,-72.08},{-41.2,-72.08}}, color={0,0,127}));
