...
equation
  ...
  connect(Building.mass_flow_rate[1:21], mulSum.u[1:21]) annotation (Line(
        points={{174.9,21.1},{178,21.1},{178,19.6667},{186.6,19.6667}},
        color={0,0,127}));
  ...
  connect(splVal1.port_2, AHU.port_a1) annotation (Line(points={{183,86},{150,86},
          {150,18},{126,18},{126,10}}, color={0,127,255}));
  ...
  annotation (Diagram(coordinateSystem(extent={{-260,-140},{260,140}})),
      ...
      __Dymola_Algorithm="Radau"),
              Icon(coordinateSystem(preserveAspectRatio=false, extent={{-260,
            -140},{260,140}})),                                  Diagram(
