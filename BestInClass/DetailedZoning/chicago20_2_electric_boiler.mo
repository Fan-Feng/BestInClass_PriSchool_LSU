...
model chicago20_2_electric_boiler
  ...
  BaseClasses.HotWaterLoop_electricboiler hotWaterLoop_electricboiler
    annotation (Placement(transformation(extent={{244,32},{264,52}})));
protected
...
equation
  ...
  connect(add2.y, hotWaterLoop_electricboiler.u) annotation (Line(points={{
          219.4,53},{219.4,52},{236,52},{236,49},{244,49}}, color={0,0,127}));
  connect(hotWaterLoop_electricboiler.port_a, splVal1.port_1) annotation (Line(
        points={{247,53},{244,53},{244,58},{224,58},{224,76},{215,76},{215,82}},
        color={0,127,255}));
  connect(hotWaterLoop_electricboiler.port_b, splVal2.port_2) annotation (Line(
        points={{261,53},{260,53},{260,78},{244,78},{244,92}}, color={0,127,255}));
  annotation (Diagram(coordinateSystem(extent={{-260,-140},{200,140}})),
      ...
      __Dymola_Algorithm="Radau"),
        ...
        coordinateSystem(preserveAspectRatio=false)),
              Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)));
end chicago20_2_electric_boiler;
