...
model Baseline
  ...
  parameter Modelica.Units.SI.PressureDifference dpBuiStaSet(displayUnit="Pa")=100 "Building static pressure";
  ...
  BaseClasses.Parameters par(
    ...
    annotation (Placement(transformation(extent={{160,102},{180,122}})));//5.1039
...
equation
  ...
  connect(zonGroSta.uGroOcc, opeModSel.uOcc) annotation (Line(points={{-118,-21},
          {-100,-21},{-100,-20},{-82,-20},{-82,-46}}, color={255,0,255}));
