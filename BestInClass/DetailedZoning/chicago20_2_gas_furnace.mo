...
model chicago20_2_gas_furnace
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus annotation (Placement(
        transformation(extent={{34,84},{46,96}}),   iconTransformation(extent=
           {{-174,26},{-154,46}})));
  BestInClass.DetailedZoning.BaseClasses.FLOOR_1964_furnace Building(
    idfFile=par.idfFile,
    weaFile=par.weaFile,
    epwFile=par.epwFile,
    ...
    annotation (Placement(transformation(extent={{154,12},{172,30}})));
  BestInClass.DetailedZoning.BaseClasses.AHU_Gas_furnace AHU(
  ...
  final A=1660.75,
  PFan=AHU.fanSup.P + 0,
  PHea = AHU.gas_consumption +
       Building.zoneVAV1.VAVbox.hea.Q_flow +
       Building.zoneVAV2.VAVbox.hea.Q_flow +
       Building.zoneVAV3.VAVbox.hea.Q_flow +
       Building.zoneVAV4.VAVbox.hea.Q_flow +
       Building.zoneVAV5.VAVbox.hea.Q_flow +
       Building.zoneVAV6.VAVbox.hea.Q_flow +
       Building.zoneVAV7.VAVbox.hea.Q_flow +
       Building.zoneVAV8.VAVbox.hea.Q_flow +
       Building.zoneVAV9.VAVbox.hea.Q_flow +
       Building.zoneVAV10.VAVbox.hea.Q_flow +
       Building.zoneVAV11.VAVbox.hea.Q_flow +
       Building.zoneVAV12.VAVbox.hea.Q_flow +
       Building.zoneVAV13.VAVbox.hea.Q_flow +
       Building.zoneVAV14.VAVbox.hea.Q_flow +
       Building.zoneVAV15.VAVbox.hea.Q_flow +
       Building.zoneVAV16.VAVbox.hea.Q_flow +
       Building.zoneVAV17.VAVbox.hea.Q_flow +
       Building.zoneVAV18.VAVbox.hea.Q_flow +
       Building.zoneVAV19.VAVbox.hea.Q_flow +
       Building.zoneVAV20.VAVbox.hea.Q_flow +
       Building.zoneVAV21.VAVbox.hea.Q_flow,
...
equation
  ...
  connect(conAHU.yOutDamPos, AHU.uOutDamPos) annotation (Line(points={{77.3,
          3.33333},{76,3.33333},{76,0},{84,0},{84,19},{93,19}},
                                     color={0,0,127}));
  connect(AHU.TSupAHU, Building.TSupAHU) annotation (Line(points={{115,10.6},{122,
          10.6},{122,18.3},{153.1,18.3}},
                                     color={0,0,127}));
  connect(AHU.supplyAir, Building.returnAir)   annotation (Line(points={{114,7.8},
          {154,7.8},{154,13.62}},                                                               color={0,127,
          255},
      thickness=0.5));
  connect(AHU.returnAir, Building.supplyAir)   annotation (Line(points={{114,24},
          {142,24},{142,28.2},{154,28.2}},                                                color={0,127,
          255},
      thickness=0.5));
  ...
  connect(Building.VDis, zonOutAirSet.VDis_flow) annotation (Line(points={{172.9,
          23.16},{180,23.16},{180,-28},{-66,-28},{-66,28},{-62,28}},
                                                             color={0,0,127}));
  connect(Building.TDis, zonOutAirSet.TDis) annotation (Line(points={{172.9,21},
          {182,21},{182,-32},{-68,-32},{-68,31},{-62,31}},
                                                      color={0,0,127}));
  connect(Building.yZonPreResReq, PZonResReq.u[1:21]) annotation (Line(points={{173.8,
          16.5},{173.8,-106},{16,-106},{16,-86.6667},{18,-86.6667}},
        color={255,127,0}));
  connect(Building.yZonTemResReq, TZonResReq.u[1:21]) annotation (Line(points={{173.8,
          18.66},{173.8,-100},{10,-100},{10,-56.6667},{18,-56.6667}},
        color={255,127,0}));
  ...
  connect(opeModSel.yOpeMod, Building.uOpeMod) annotation (Line(points={{-58,-60},
          {-50,-60},{-50,-20},{140,-20},{140,15.6},{152.2,15.6}},
                                                               color={255,127,0}));
  ...
  connect(TZonSet[1].TZonCooSet, Building.TRooCooSet) annotation (Line(points={{-58,-92},
          {6,-92},{6,-24},{144,-24},{144,21},{153.1,21}},         color={0,0,
          127}));
  connect(TZonSet[1].TZonHeaSet, Building.TRooHeaSet) annotation (Line(points={{-58,
          -100},{8,-100},{8,-26},{146,-26},{146,23.7},{153.1,23.7}},color={0,0,
          127}));
  ...
  connect(Building.TRooAir, zonSta.TZon) annotation (Line(points={{172.9,25.5},{
          184,25.5},{184,-132},{-206,-132},{-206,-86},{-202,-86}},
                                                             color={0,0,127}));
  connect(Building.TRooAir, zonOutAirSet.TZon) annotation (Line(points={{172.9,25.5},
          {184,25.5},{184,-30},{-70,-30},{-70,34},{-62,34}},
                                                           color={0,0,127}));
  ...
  connect(zonGroSta.TZon, Building.TRooAir) annotation (Line(points={{-142,-57},
          {-146,-57},{-146,-132},{184,-132},{184,25.5},{172.9,25.5}},
                                                                color={0,0,127}));
  ...
  connect(conAHU.TSupSet, AHU.TSet) annotation (Line(points={{77.3,30},{76,30},{
          76,38},{86,38},{86,7},{93,7}}, color={0,0,127}));
