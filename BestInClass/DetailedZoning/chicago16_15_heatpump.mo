...
model chicago16_15_heatpump
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant warUpTim[numZon](final k=
    ...
    annotation (Placement(transformation(extent={{-246,-80},{-234,-68}})));
...
equation
  ...
  connect(warUpTim.y, zonSta.warUpTim)
    annotation (Line(points={{-232.8,-74},{-202,-74}}, color={0,0,127}));
