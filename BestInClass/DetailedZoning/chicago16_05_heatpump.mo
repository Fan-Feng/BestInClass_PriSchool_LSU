...
model chicago16_05_heatpump
  ...
  parameter Modelica.Units.SI.MassFlowRate AHUAir_Nominal=4.22;

  parameter Modelica.Units.SI.MassFlowRate AHUHotWater_Nominal= AHUAir_Nominal*1006*(16.7 - 8.5)/4200/10;
  parameter Modelica.Units.SI.MassFlowRate BuildingAir_Nominal= 3.631726;

  parameter Modelica.Units.SI.MassFlowRate BuildingHotWater_Nominal= BuildingAir_Nominal*1006*(28 - 16.7)/4200/(55 - 45);
  ...
  BaseClasses.Parameters par(
    ...
    m_flow_zone=1.2*{0.066390,0.059453,0.059444,0.026067,0.199555,0.160151,0.174096,
                     0.173591,0.046964,0.173929,0.154452,0.120121,0.119417,0.090836,
                     0.401758,0.438377,0.439564,0.504256,0.106509,0.058400,0.058396},
    m_flow_sys=1.2*4.22)
